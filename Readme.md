...
* Студент: [Неопознанный Квокка](https://up.htmlacademy.ru/htmlcss/34/user/475753).
* Наставник: `Неизвестно`.ddddd
afafaff
---
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/475753-sedona-34) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
